<div class="grid grid-cols-4 gap-2 ">
    <div class="bg-gradient-to-br from-[#28a8e0] to-blue-500 text-white p-1 rounded-lg shadow-md flex flex-col 1 text-center ">
        <div class="font-semibold">Hari & Waktu</div>
        <div id="realTimeClock" class="text-sm font-bold mt-1"></div>
    </div>
    <div class="bg-white p-1 rounded-lg shadow-md text-center flex flex-col  ">
    ...
    <div id="accidentCard" class="bg-white p-1 rounded-lg shadow-md text-center border flex flex-col   {{ ($accidentCount ?? 0) > 0 ? 'border-red-500 cursor-pointer hover:bg-red-50' : 'border-gray-200' }}">
