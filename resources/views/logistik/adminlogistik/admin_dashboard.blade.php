                            ...
                            <div class="flex-shrink-0">
                                <span class="inline-flex h-8 w-8 items-center justify-center rounded-full {{ $activity->status === 'approved' ? 'bg-green-100' : ($activity->status === 'pending' ? 'bg-yellow-100' : 'bg-red-100') }}">
                                    ...
                                    @elseif ($activity->status === 'pending')
                                        <svg class="h-5 w-5 text-yellow-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 5.168A.75.75 0 0110 4.5h.001c.245 0 .45.154.545.384l.01.032a9.006 9.006 0 000 7.168A.75.75 0 0110 12.5h-.001a.75.75 0 01-.546-.884l.01-.032a9.006 9.006 0 000-7.168zM10 15a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" /></svg>
                                    @else {{-- rejected --}}
