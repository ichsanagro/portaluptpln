...
@section('title', 'Monitoring Kerusakan Material')
    ...
    <div class="border-b border-slate-200 p-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div class="w-full md:w-auto">
                <h3 class="text-xl font-semibold text-slate-800">Monitoring Laporan Kerusakan</h3>
                <p class="mt-1 text-sm text-slate-600">Berikut adalah daftar semua laporan kerusakan material dalam mode read-only.</p>
            </div>
        </div>
    </div>
